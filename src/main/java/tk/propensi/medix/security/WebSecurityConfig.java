...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http
                ...
                .antMatchers("/pendaftar/**","/viewall","/viewall-flagged","/rekamMedisFlag/**").hasAuthority("Admin Medix")
                .antMatchers("/rekamMedis/**","/rekamMedisHide/**","/viewall-hidden").hasAuthority("Admin Khanza")
